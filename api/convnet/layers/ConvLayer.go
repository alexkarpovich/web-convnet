...
func (l *ConvLayer) Prepare() {
	...
	l.imSize = make([]int, 2)
	l.in = make([]float64, outSize[0]*outSize[1]*l.count*l.inCount)
	l.im = make([]float64, outSize[0]*outSize[1]*l.inCount)
	l.out = make([]float64, outSize[0]*outSize[1]*l.count*l.inCount)
	l.deltas = make([]float64, outSize[0]*outSize[1]*l.count*l.inCount)
}
